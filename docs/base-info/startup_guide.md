...
10. **Контент менеджер** – займається плануванням і створенням контенту, візуальним та текстовим наповнення. Частіше працює вже з готовим з готовими матеріалами ніж їх розробкою.
...
14. **Контент менеджер** – людина яка працює над плануванням публікації контенту в соцмережах. Також в її обов`язки може входити підбір візуального матеріалу та копірайту.
...
15. **Game design спеціаліст** – як можна здогадатися з назви, ця людина займається розробкою зовнішніх складових ігор. Наприклад дизайн середовища (яким буде світ у грі, як складно буде в ньому існувати гравцю), інтерфейс гри та інше.

16. **UI/UX спеціаліст** — це креативний фахівець, який проєктує призначені для користувача інтерфейси. UI та UX — це різні сторони дизайну.
...
17. **Графічний дизайнер**. Його робота полягає у роботі з зображеннями. 
...
18. **Дизайнер анімації** – спеціаліст галузі графічного дизайну, але займається безпосередньо розробкою анімаційних роликів, анімацією у 2D та 3D
...
19. **Product менеджер** — стоїть на межі між процесами розробки, менеджменту та маркетингу. Займається стратегіями розвитку продукту в напрямку більшої функціональності, цінності та розширення продукту для користувачів на ринку.

20. **Бізнес-аналітик** – займається аналізом та максимально ефективним плануванням процесів які відбуваються в команді, щодо продукту і внутрішніх процесів.

21. **Project менеджер** – відповідає за певну групу спеціалістів, координує роботу та стежить за виконанням поставлених задач

22. **Системний адміністратор** – спеціаліст забезпечує роботу комп'ютерної техніки, комп'ютерної мережі й програмного забезпечення в організації. 

23. **Спеціаліст з кібербезпеки** – займається розробкою охоронних систем для різних комунікаційних мереж і електронних баз даних, тестує і вдосконалює власні та сторонні розробки для уникнення ризиків витоку відомостей, що становлять державну або комерційну таємницю, конфіденційну інформацію. Цю роботу можуть виконувати як окремо поставлені люди, так і ті хто пишуть Backend.

## Висновок ##

Важливо зазначити, в усі вище перераховані спеціальносі можна ввійти одразу, або з мінімальними навичками.

Ми не згадали про вищі посади на кшталт тех.директорів, тім лідів та подібних, адже це спеціалісти, які вже повинні мати деякий досвід в тій чи іншій сфері. А усі вище перераховані спеціальності можна вивчити та одразу починати працювати, без попереднього досвіду.
...
Ми сподіваємося, що цей гайд був для вас корисним. Також ми розуміємо що можуть бути певні неточності, тому відкриті до ваших зауважень. Будемо раді зворотньому зв'язку з вашими думками стосовно цього гайду.

#### Автори ####
Автор ідеї та тексту, головний координатор - [Антон](https://www.instagram.com/anton_yurash/). Копірайтер, редактор - [Юрій](https://www.instagram.com/y.rozhytskyj/).
