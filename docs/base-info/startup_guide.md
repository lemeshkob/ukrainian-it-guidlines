...
Якщо визначилися із напрямком, [шукайте матеріали та покрокову інструкцію для навчання тут](https://github.com/lemeshkob/ukrainian-it-guidlines). Інформація постійно поповнюється.
